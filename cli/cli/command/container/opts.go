...
'':        Use the cgroup namespace as configured by the
	...
	flags.Var(&copts.memoryRemote, "memory-remote", "Remote memory limit")
	flags.Var(&copts.memoryRemoteSwap, "memory-remote-swap", "Remote swap limit")
...
func parse(flags *pflag.FlagSet, copts *containerOptions, serverOS string) (*containerConfig, error) {
	...
	resources := container.Resources{
		...
		MemoryRemote:         copts.memoryRemote.Value(),
		MemoryRemoteSwap:     copts.memoryRemoteSwap.Value(),
