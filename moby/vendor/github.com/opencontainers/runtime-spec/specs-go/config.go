...
type LinuxResources struct {
	...
	// RemoteMemory configuration
	RemoteMemory *LinuxRemoteMemory `json:"remoteMemory,omitempty"`
}

// LinuxRemoteMemory represents the remote memory configuration for a container
